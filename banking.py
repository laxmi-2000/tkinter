	...
	if ac.get()=="":
		...
		for i in Information.items():
			if int(ac.get()) == Information['Account'] and len(ac.get()) == 14:
				...
				name = Label(des , text = "Name :" , font = 'z003 24 bold',bg="#CD5C5C")
				name.place(x=200, y=160,anchor='e')

				amount = Label(des , text = "Amount :" , font = 'z003 24 bold',bg="#CD5C5C")
				amount.place(x=200 , y=220,anchor='e')

				mobile = Label(des , text = "Mobile No :" , font = 'z003 24 bold',bg="#CD5C5C")
				mobile.place(x=200 , y=280,anchor='e')

				funds = Label(des , text = "Source Of Funds :" , font = 'z003 20 bold',bg="#CD5C5C")
				funds.place(x=200 , y=330,anchor='e')

				others = Label(des , text = "Others :" , font = 'z003 24 bold',bg="#CD5C5C")
				others.place(x=200 , y=470,anchor='e')

				name = Entry(des, bd=5,width=40,font = 'z003 24 bold', textvariable = name)
				name.place(x=220 , y= 144)
				name.insert(0,data_name)

				amount = Entry(des, bd=5,width=40,font = 'z003 24 bold', textvariable = amount)
				amount.place(x=220 , y= 205)
				amount.insert(0,data_amount)

				mobile = Entry(des, bd=5,width=40,font = 'z003 24 bold', textvariable = mobile)
				mobile.place(x=220 , y= 262)
				mobile.insert(0,data_mobile)

				Radio_button_sal = Radiobutton(des,text='Salary', value="salary",font = 'z003 15 bold',variable = var)
				Radio_button_sal .place(x= 220 , y= 320)
				var.set('salary')

				Radio_button_vah = Radiobutton(des,text='Vahical Sale', value="vahical",font = 'z003 15 bold',variable = var)
				Radio_button_vah .place(x= 220 , y= 350)

				Radio_button_pro = Radiobutton(des,text='Property Sale', value="property",font = 'z003 15 bold',variable = var)
				Radio_button_pro .place(x= 220 , y= 380)

				Radio_button_others = Radiobutton(des,text='Others', value="others",font = 'z003 15 bold',variable = var)
				Radio_button_others .place(x= 220 , y= 410)

				others = Entry(des, bd=5,width=40,font = 'z003 24 bold', textvariable = others)
				others.place(x=220 , y= 455)
				others.insert(0,data_others)

				clear = Button(des, text = "Clear" ,font='z003 16 bold', command = clear)
...
mobile = StringVar()
others = StringVar()
ac_no = Label(des , text = "Account No :" , font = 'z003 24 bold',bg="#CD5C5C")
ac_no.place(x=200 , y=100,anchor='e')	

ac = Entry(des, bd=5,width=40,font = 'z003 17 bold',textvariable = ac)
ac.focus()
ac.place(x=220 , y= 85)
...
enter = Button(des, text = "Enter" ,font='z003 13 bold', command = action)
enter.place(x=680, y=85)

scan = Button(des, text = "Scan" ,font='z003 13 bold', width=12, height=6,  command = scan)
scan.place(x=930, y=130)

cancel = Button(des, text = "Cancel" ,font='z003 13 bold', width=12, height=6,  command = cancel)
